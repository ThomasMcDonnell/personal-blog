<template>
  <div class="font-sans text-gray-800 landing-normal flex flex-col min-h-screen">
    ...
    <svg fill="#edf2f7" viewBox="0 0 1695 57" class="text-fill-primary">
      <path d="M0 23c135.4 19 289.6 28.5 462.5 28.5C721.9 51.5 936.7 1 1212.2 1c183.6-.1 344.5 7.3 482.8 22v34H0V23z">
      </path>
    </svg>
    <div class="contact bg-gray-200">
      <div class="container-inner mx-auto py-16 pb-8 text-center text-xl">
        <h2 class="text-2xl font-bold mb-8">Get in Touch & Subscribe</h2>
        <p class="mb-8 text-xl">Feel free to drop me an email if you like my content and think I could help you with a project, or
          subscribe to my newsletter and get updated when new content comes out.</p>
        <form action="#">
          <div class="flex flex-col sm:flex-row">
            <input type="email" name="email" placeholder="Your Email" class="font-sans flex-1 bg-background-form rounded sm:rounded-r-none px-4 py-4 leading-normal border border-border-color-green sm:border-r-0 shadow outline-none focus:border-green-600 z-10" required>
            <button class="flex-2 w-40 uppercase bg-green-400 text-white rounded sm:rounded-l-none text-lg py-3 px-8 tracking-wide shadow focus:outline-none hover:bg-green-600 focus:bg-green-600 z-10 w-full sm:w-auto mt-4 sm:mt-0">
              <span>Subscribe</span>
            </button>
          </div>
        </form>
    ...
    <footer class="bg-green-400 text-white">
      <div class="container mx-auto flex items-center justify-between py-8">
        ...
        <ul class="flex items-center">
          <li class="mr-8">
            <a href="#">
              <svg width="25" height="20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path d="M2.5 0h20A2.5 2.5 0 0 1 25 2.5v15a2.5 2.5 0 0 1-2.5 2.5h-20A2.5 2.5 0 0 1 0 17.5v-15C0 1.125
                1.125 0 2.5 0zm20 4.225V2.5h-20v1.725l10 5 10-5zm0 2.8l-9.438 4.713a1.25 1.25 0 0 1-1.124 0L2.5
                7.025V17.5h20V7.025z" fill-rule="nonzero"></path>
              </svg>
            </a>
          </li>
          <li class="mr-8">
          ...
          <li class="mr-8">
            <a href="#">
              <svg width="25" height="20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path d="M19.807 1.943a8.588 8.588 0 0 1-2.036 2.135 11.918 11.918 0 0 1-.465 3.854 12.085 12.085 0 0
                1-1.452 3.177 12.426 12.426 0 0 1-2.318 2.691c-.897.78-1.978 1.402-3.243 1.867-1.265.464-2.618.697-4.06.697-2.27
                0-4.348-.618-6.233-1.854.293.034.62.051.98.051 1.885 0 3.565-.588 5.04-1.764a3.915 3.915 0 0 1-2.363-.825 4.038 4.038
                0 0 1-1.432-2.039c.276.043.532.064.766.064.36 0 .717-.047 1.068-.14A3.982 3.982 0 0 1 1.73 8.43c-.617-.754-.925-1.63-.925-2.627v-.051c.57.324 1.182.498 1.835.524a4.1 4.1 0 0 1-1.32-1.47
                4.078 4.078 0 0 1-.49-1.969c0-.75.185-1.445.553-2.084a11.548 11.548 0 0 0 3.702 3.05 11.163 11.163 0 0 0 4.669
                1.271c-.067-.324-.1-.639-.1-.946 0-1.142.395-2.116 1.187-2.92C11.632.402 12.589 0 13.712 0c1.173 0 2.161.435 2.966 1.304a7.878 7.878 0 0 0 2.576-.997
                 3.997 3.997 0 0 1-1.785 2.275 7.98 7.98 0 0 0 2.338-.639z" fill-rule="nonzero"></path>
              </svg>
            </a>
          </li>
        </ul>
